...
public class EmpLeaveController {
	...
	/*
	 * To apply leave as an employee or manager which calls empleave in LeaveHelperClass to perform this function
	 */
	...
	/*
	 * To retrieve a list of employee under a particular manager to grant permission for leave which calls grantleave in LeaveHelperClass to perform this function
	 */
	...
	/*
	 * To accept or reject the leave by the manager which calls grantpermission in LeaveHelperClass to perform this function
	 */
	...
	/*
	 * To check status for the applied leave which calls checkstatus in LeaveHelperClass to perform this function
	 */
