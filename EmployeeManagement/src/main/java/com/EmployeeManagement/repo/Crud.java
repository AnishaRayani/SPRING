...
public class Crud implements CrudInterface {
	 ...
	 * employee or admin which calls Repository to perform this function
	 */
	@Override
	...
	/*
	 * To validate the username and password and tell whether it is a manager ,
	 * employee or admin which calls EmpRepository to perform this function
	 */
	@Override
	...
	/*
	 * To add an employee which calls EmpRepository to perform this function and
	 * even it calls Repository to add the username and password in adminbean table
	 */
	@Override
	...
	/*
	 * To delete an employee which calls EmpRepository to perform this function and
	 * even it calls Repository to delete the username and password in adminbean
	 * table
	 */
	 ...
	 * EmpRepository to perform this function
	 */
	...
	/*
	 * To retrieve a list of employee details with pf which calls EmpRepository to
	 ...
	 * 20000 which calls EmpRepository to perform this function
	 */
	...
	/*
	 * To apply leave as an employee or manager which calls EmpRepository to perform
	 * this function
	 */
	 ...
	 * for leave which calls EmpRepository to perform this function
	 */
	...
	/*
	 * To accept or reject the leave by the manager which calls EmpRepository to
	 * perform this function
	 */
	...
	/*
	 * To check status for the applied leave which calls EmpRepository to perform
	 * this function
	 */
