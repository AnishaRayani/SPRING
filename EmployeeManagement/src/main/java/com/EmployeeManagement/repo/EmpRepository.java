...
public interface EmpRepository extends JpaRepository<EmpBean, String> {
	/*
	 * To validate the username and password and tell whether it is a manager , employee or admin 
	 */
	@Query(value = "select e from EmpBean e where e.reportingmanager= :name")
	public List<EmpBean> getuser(@Param("name") String name);
	/*
	 * To retrieve a list of employee details using empid so as to add or delete an employee
	 */
	...
	/*
	 * To retrieve a list of employee details whose salary range between 10000 and 20000 
	 */
