...
public interface LeaveRepository extends JpaRepository<LeaveBean, Integer> {
	/*
	 * To retrieve a list of leaves applied by an employee under a particular manager
	 */
	...
	/*
	 * To retrieve a list of leaves applied by an employee to check status for the applied leave
	 */
